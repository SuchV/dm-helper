  ...
  return (
    <>
      <Tooltip>
            ...
            >
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                ...
                <DialogContent>
                  ...
                  {isCompleted ? "uncomplete" : "complete"} this entry?
                  <Button
                    variant="primary"
                    type="button"
                    disabled={isPending}
              ...
              <div className="absolute right-0 top-0 z-10">
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    ...
                    <DialogDescription>
                      Are you sure you want to remove this bingo entry? This
        ...
        <TooltipContent>some example toltip content...</TooltipContent>
      </Tooltip>
    </>
  );
};
