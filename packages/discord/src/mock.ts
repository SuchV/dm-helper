...
import { memberGuildsArray } from "./mocks/memberGuilds";
import { botGuildsArray } from "./mocks/botGuilds";
import { guildMembersArray } from "./mocks/guildMembers";
import { guildDetails } from "./mocks/guildDetails";

export class DiscordAPIClientMock {
  ...
  public async getUserGuilds(
    ...
    return memberGuildsArray satisfies Partial<APIGuild>[];
  ...
  public async getBotGuilds() {
    return botGuildsArray satisfies Partial<APIGuild>[];
  ...
  public async getGuildDetails(guildId: string) {
    return guildDetails;
  ...
  public async getGuildMembers(guildId: string, includeBots: boolean) {
