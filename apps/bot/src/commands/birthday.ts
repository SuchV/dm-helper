...
import { CustomSlashCommand } from "../helpers/custom-slash-command";

export const data: CustomSlashCommand = new SlashCommandBuilder()
  .setName("birthday")
...
export const cooldown = 60; // 60 seconds cooldown
